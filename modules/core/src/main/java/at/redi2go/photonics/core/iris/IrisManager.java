...
public class IrisManager {
    ...
    public static Optional<PhotonicsPipeline> getPipeline() {
        return Optional.ofNullable(activePipeline);
    }

    public static <T> T getRendererProperties(Class<T> type) {
        return propertiesManager.getProperties(type);
    }
