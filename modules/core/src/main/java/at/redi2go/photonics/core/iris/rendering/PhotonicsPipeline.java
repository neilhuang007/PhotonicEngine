...
public abstract class PhotonicsPipeline extends AbstractRenderingComponent {
    ...
    public java.util.List<at.redi2go.photonics.core.rendering.lights.TracedLightPosition> tracedLightsSnapshot() {
        return lightList == null ? java.util.List.of() : lightList.snapshot();
    }
